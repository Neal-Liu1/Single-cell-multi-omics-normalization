...
```{r}
# Find NCGs
ncgs <- RUVIIIPRPS::findNcgSupervised(
  merged_rna_singlecellexperiment,
  assay.name = 'RNA', 
  bio.variables = 'celltype.l2_with_transfer', 
  uv.variables = c('study', 'log2_libsize'),
  save.se.obj = F,
  assess.se.obj = F,
  assess.ncg = T,
...
panc8_metrics <- RunRUVIII(panc8_metrics, ncgs, k = 2, celltype = '')
