...
```
```{r}
p1 <- PlotMultipleSilhouette(test, 'batch', 'violin', 'Batch silhouette', 1.2)
p2 <- PlotMultipleSilhouette(test, 'K3', 'violin', 'Celltype silhouette', 1.2)
gridExtra::grid.arrange(p1,p2, ncol=2)
```
```{r}
...
```
```{r}
p1 <- PlotHVG_Conservation(test, 'batch')
