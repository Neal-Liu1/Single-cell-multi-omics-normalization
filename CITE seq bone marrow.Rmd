...
setGeneric('ComputeARIs',
           function(obj, labels, hclust_method = 'complete', distance_type  = 'euclidean'){standardGeneric('ComputeARIs')})
...
sample <- sample(nrow(merged_adt_metrics@PCs$Raw_counts), 3000)
...
test <- ComputeARIs(test, 'celltype.l2_with_transfer')
test <- ComputeARIs(test, 'study')
