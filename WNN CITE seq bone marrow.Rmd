...
devtools::source_url('https://github.com/Neal-Liu1/Multi-omics-integration/blob/main/Helper_functions.R')
...
To benchmark with other methods such as totalVI (which is written in python), we need to use the reticulate package to operate python in R. 
