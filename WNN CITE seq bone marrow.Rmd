...
```{r}
plot_vector_correlation(list(adt_data, bm_data@assays$ADT$data, t(adt_dsb), adt_adtnorm, totalVI_normalized), c('Raw counts', 'CLR', 'DSB', 'ADTnorm', 'totalVI'), 
...
```{r}
plot_linear_correlation(list(adt_data, bm_data@assays$ADT$data, t(adt_dsb), adt_adtnorm, totalVI_normalized), c('Raw counts', 'CLR', 'DSB', 'ADTnorm', 'totalVI'), 
